...
import { Web3sdkioLogo } from "./icons/Web3sdkioLogo"
      ...
      <Grid gap={8}>
        ...
        <Grid gap={5}>
          ...
          <Flex
            ...
            align="center"
          >
            <Tooltip label="Powered by web3sdkio">
              <IconButton
                aria-label="web3sdkio link"
                as="a"
                variant="ghost"
                colorScheme="blackAlpha"
                href="https://web3sdk.io/?utm_source=makeswift"
                target="_blank"
                rel="noreferrer"
              >
                <Web3sdkioLogo />
...
const NFTDropCardProvider = forwardRef(function NFTDropCardProvider(
  ...
  return (
    <Web3sdkioProvider desiredChainId={Number(chainId)}>
      <ChakraProvider
        theme={extendTheme({
          fonts: {
